...
public class ToLearnHardAssert {
	...
	public void login() {
		...
		Assert.assertEquals(driver.getTitle(), "Demo Web Shop. Login", "Login page id displayed");
		...
		Assert.assertEquals(driver.getTitle(), "Demo Web Shop", "Home page id displayed");
